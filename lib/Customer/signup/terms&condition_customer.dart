...
class CustTermsAndConditionsPage extends StatefulWidget {
  const CustTermsAndConditionsPage({super.key});

  @override
  State<CustTermsAndConditionsPage> createState() =>
      _CustTermsAndConditionsPageState();
}

class _CustTermsAndConditionsPageState
    extends State<CustTermsAndConditionsPage> {
  ...
  final List<Map<String, dynamic>> terms = [
    {
      "title": "Introductions",
      "bullets": [
        "Welcome to ThreadHub. By using our services, you agree to abide by these Terms and Conditions. Please read them carefully.",
      ],
    },
    {
      ...
      "bullets": [
        ...
        "Notify administrator immediately of any unauthorized use of your account.",
      ],
    },
    {
      "title": "Use of Services",
      "bullets": [
        "Use the platform solely for its intended purposes.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Do not give any of your data outside the application unless you are contacted by the administrator on this system.",
        "You can also report fellow tailors and customers if they violate your privacy or business.",
      ],
    },
    {
      "title": "Cancellations and Refunds",
      "bullets": [
        "Follow the tailor's cancellation policy.",
        "Request refunds as per the agreed terms with the tailor.",
      ],
    },
  ];
