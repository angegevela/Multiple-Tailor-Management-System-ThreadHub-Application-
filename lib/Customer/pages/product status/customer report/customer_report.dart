...
import 'package:threadhub_system/Customer/pages/product%20status/customer%20report/review_report.dart';
...
class _ReportPageState extends State<ReportPage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const SizedBox(height: 10),
            buildTextField(context, "Reportees Name", reporteeNameController),
            const SizedBox(height: 10),
            buildTextField(
              context,
              "Report Description",
  ...
  Widget buildTextField(
    BuildContext context, // 👈 pass context as parameter
    String label,
    TextEditingController controller, {
    int maxLines = 1,
    String? hint,
  }) {
    final fontSize = context.watch<FontProvider>().fontSize; // 👈 now valid
